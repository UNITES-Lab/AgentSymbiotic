...
from Agent.rag import get_examples
from Agent.utils import CURRENT_DIR, HOMEPAGE_URL
...
class Actor(Agent):
    def __init__(self, config, objective, prompt_template, plan_tree_node):
        ...
        self.lastaction="NO last action"
